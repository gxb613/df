  ...
  <div class="login_layout">
    ...
    <div class="val">
      ...
      <div class="search">
		...
		<div class="search">
			<p style="color:#337ab7; font-size:14px;">浦东</p>
			<p><img src="/static/images/pudong_160.png" /></p>
			<p style="color:#337ab7; font-size:14px;">杨浦</p>
			<p><img src="/static/images/yangpu_160.png" /></p>
		</div>
      </div>
      </div>
    </div>
